...
- Pure-Java **EC-SRA / Ristretto255** implementation (RFC 9496) with DLEQ-proof verifiable dealing and a zero-knowledge **Bayer–Groth verifiable shuffle** — no native crypto dependencies
