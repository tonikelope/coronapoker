...
class SecureChannelCodecTest {
    ...
    void preservesTheExistingDeterministicTextWireAndRoundTripsBinary() throws Exception {
        ...
        assertEquals(AuthenticatedCommandCodec.encrypt("GAME#7#HELLO", AES, IV, HMAC), frame,
                "GDX/core transport must remain byte-for-byte compatible with the codec used by Swing");
