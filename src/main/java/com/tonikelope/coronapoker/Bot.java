...
public class Bot {
    ...
    public int calculateBotDecision(int opponents) {
        ...
        } else if (poseffectiveStrength >= 0.65f && !(effectiveStrength < 0.80f && fase == Crupier.RIVER && Helpers.float1DSecureCompare(cpu_player.getStack(), GameFrame.getInstance().getCrupier().getApuesta_actual() - cpu_player.getBet()) <= 0)) {
