...
public final class GameFrame extends javax.swing.JFrame implements ZoomableInterface, MouseWheelListener {
    ...
    public static volatile boolean RADAR_AVAILABLE = Boolean.parseBoolean(Helpers.PROPERTIES.getProperty("radar", "false"));
        ...
        if (GameFrame.SONIDOS_TTS) {
            ...
            if (!GameFrame.TTS_SERVER && GameFrame.getInstance().isPartida_local()) {
                ...
                Helpers.threadRun(() -> {
                    ...
                    Helpers.GUIRun(() -> {
                        ...
                        InGameNotifyDialog dialog = new InGameNotifyDialog(GameFrame.getInstance(), false, Translator.translate("TTS ACTIVADO POR EL SERVIDOR"), new Color(0, 130, 0), Color.WHITE, null, NOTIFICATION_TIMEOUT);
            ...
            Helpers.threadRun(() -> {
                ...
                Helpers.GUIRun(() -> {
                    ...
                    InGameNotifyDialog dialog = new InGameNotifyDialog(GameFrame.getInstance(), false, Translator.translate("TTS DESACTIVADO POR EL SERVIDOR"), Color.RED, Color.WHITE, null, NOTIFICATION_TIMEOUT);
