...
public abstract class TablePanel extends javax.swing.JLayeredPane implements ZoomableInterface {
    ...
    // Reproduce los GIFs de giro de varias cartas A LA VEZ sobre overlays
    // efímeros en POPUP_LAYER (uno por carta, centrado sobre ella), con el
    // mismo motor catch-up y los mismos relevos sin hueco que
    ...
    // más delay_end. No toca central_label ni su takeover: los overlays se
