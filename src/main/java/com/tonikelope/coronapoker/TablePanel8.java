...
public class TablePanel8 extends TablePanel {
    ...
    public TablePanel8() {
        Helpers.GUIRunAndWait(() -> {
            ...
            zoomables = new ZoomableInterface[]{localPlayer, remotePlayer1, remotePlayer2, remotePlayer3, remotePlayer4, remotePlayer5, remotePlayer6, remotePlayer7, communityCards, fastbuttons};
        });
    }
