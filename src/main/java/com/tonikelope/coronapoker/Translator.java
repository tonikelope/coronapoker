...
public class Translator {
    ...
    private static void English() {
        ...
        String[][] rosetta = {
            ...
            {"YA TIENES UNA SOLICITUD DE RECOMPRA ACTIVADA", "YOU ALREADY HAVE A REBUY REQUEST PENDING"},
            {"PARA RECOMPRAR DEBES TENER MENOS STACK QUE EL BUYIN DE LA TIMBA", "TO REBUY YOU MUST HAVE LESS STACK THAN GAME BUYIN"},
            ...
            {"Rojo", "Red"},
            {"Sin tapete", "No mat"},
            {"(AUTO) PASAR [ENT]", "(AUTO) CHECK [ENT]"},
            {"(AUTO) NO IR [ESC]", "(AUTO) FOLD [ESC]"},
            {"Crear timba", "Create game"},
            {"Unirme a timba", "Join game"},
