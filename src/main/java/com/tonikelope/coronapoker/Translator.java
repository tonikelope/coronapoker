...
public class Translator {
    ...
    private static void English() {
        ...
        String[][] rosetta = {
            {"LA REGLA \"IWTSTH\" NO ES UN DERECHO, ES UN PRIVILEGIO (PARA INTENTAR DEMOSTRAR UNA PRESUNTA COLUSIÓN)\nSU USO PARA OBTENER INFORMACIÓN SOBRE EL ESTILO DE JUEGO DEL RESTO DE JUGADORES NO ESTÁ PERMITIDO Y SE \nCONSIDERA UN USO ABUSIVO\n\n(Habla con el encargado si piensas que ESTÁ TOTALMENTE JUSTIFICADO volver a utilizarla)", "THE \"IWTSTH\" RULE IS NOT A RIGHT, IT IS A PRIVILEGE (TO PROVE ALLEGED COLLUSION)\nITS USE TO OBTAIN INFORMATION ABOUT THE PLAY STYLE OF OTHER PLAYERS IS NOT ALLOWED AND IS \nCONSIDERED AN ABUSIVE USE\n(Talk to the supervisor if you think IT IS TOTALLY JUSTIFIED to use it again)"},
