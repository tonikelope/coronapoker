param(
    ...
    [ValidateSet('normal', 'abrupt-exit', 'controlled-exit', 'allin-rit', 'allin-controlled-exit', 'force-recover', 'double-force-recover', 'crash-rejoin-recover', 'force-recover-add-client')]
