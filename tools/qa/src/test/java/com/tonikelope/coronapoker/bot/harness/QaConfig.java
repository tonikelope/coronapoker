...
/**
 * Runtime knobs for the matchup/baseline benchmarks so volume can be lowered
 ...
 *
 * <p>
 * The qa {@code pom.xml} forwards these properties into the surefire forks via
 * {@code <systemPropertyVariables>}; when a property is not supplied it arrives
 * as the unresolved literal {@code "${qa.sessions}"}, which
 * {@link Integer#getInteger} cannot parse and therefore falls back to the
 * per-test default passed here.</p>
 */
